#[test_only]
module tobmate_enterprise_security::cross_network_security_orchestration_binding_tests_01_02 {
    ...
    #[test]
    fun test_01_approved_case_and_pending_authorization_binding() {
        let mut scenario =
    ...
    #[test]
    fun test_02_consumed_authorization_confirmation() {
        let mut scenario =
            sui::test_scenario::begin(@0xA);
