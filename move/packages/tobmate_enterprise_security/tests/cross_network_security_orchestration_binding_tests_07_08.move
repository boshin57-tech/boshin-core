#[test_only]
module tobmate_enterprise_security::cross_network_security_orchestration_binding_tests_07_08 {
    ...
    fun test_07_authorization_binding_wrong_state_rejected() {
        let mut scenario =
        ...
        // Orchestrator is now AUTHORIZED, not OPEN.
        cross_network_security_orchestration_binding::
            bind_pending_authorization(
                &mut orchestration,
                &case,
    ...
    fun test_08_remediation_before_authorization_rejected() {
        let mut scenario =
            sui::test_scenario::begin(@0xA);
