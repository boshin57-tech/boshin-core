#[test_only]
module tobmate_enterprise_security::cross_network_remediation_execution_governance_tests_07_08 {
    ...
    fun test_07_recovery_before_execution_receipt_rejected() {
        let mut scenario =
        ...
        // RemediationRecord is bound, but no execution receipt
        // has been confirmed. Recovery must be rejected.
        cross_network_security_orchestrator::
            begin_recovery(
                &mut orchestration,
            );
        ...
        assert!(
            cross_network_remediation_execution_governance::
                total_started(&execution_governance)
                == 1,
            74003,
        );
cross_network_remediation::
    ...
    #[test]
    #[expected_failure(abort_code = 1207501)]
    fun test_08_duplicate_execution_confirmation_rejected() {
        let mut scenario =
            sui::test_scenario::begin(@0xA);
        ...
        // Same execution evidence must never advance the
        // orchestration state twice.
        cross_network_remediation_execution_binding::
            confirm_execution(
                &mut orchestration,
                &execution_governance,
