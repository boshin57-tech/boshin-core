#[test_only]
module tobmate_enterprise_security::cross_network_remediation_execution_governance_tests_05_06 {
    ...
    #[test]
    fun test_05_remediation_binding_requires_execution_evidence() {
        let mut scenario =
...
cross_network_remediation::
    ...
    #[test]
    fun test_06_execution_receipt_advances_to_remediated() {
        let mut scenario =
            sui::test_scenario::begin(@0xA);
