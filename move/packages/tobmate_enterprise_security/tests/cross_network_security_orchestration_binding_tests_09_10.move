#[test_only]
module tobmate_enterprise_security::cross_network_security_orchestration_binding_tests_09_10 {
    ...
    fun test_09_recovery_before_remediation_rejected() {
        let mut scenario =
        ...
        // Must fail: no remediation evidence has been bound yet.
        cross_network_security_orchestrator::
            begin_recovery(
                &mut orchestration,
            );
    ...
    fun test_10_duplicate_authorization_confirmation_rejected() {
        let mut scenario =
            sui::test_scenario::begin(@0xA);
