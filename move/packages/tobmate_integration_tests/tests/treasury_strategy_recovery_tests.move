#[test_only]
module tobmate_integration_tests::treasury_strategy_recovery_tests;
...
use tobmate_finance::treasury_strategy_recovery::{
...
#[expected_failure(
    abort_code = 4,
    location = tobmate_finance::treasury_strategy_recovery,
)]
...
fun test_15_no_loss_coverage_is_full() {
    use tobmate_finance::treasury_strategy_recovery_mode::{
...
#[expected_failure(
    abort_code = 20,
    location = tobmate_finance::treasury_yield_engine,
)]
...
#[expected_failure(
    abort_code = 3,
    location = tobmate_finance::treasury_strategy_recovery_mode,
)]
