#[test_only]
module tobmate_integration_tests::gold_marketplace_adapter_tests;

use sui::test_scenario::{Self as test_scenario};

use tobmate_foundation::access_control::{Self as access_control};
use tobmate_asset::backing_position::{Self as backing_position};
use tobmate_asset::dual_ownership::{Self as dual_ownership};
use tobmate_asset::gold_marketplace_adapter::{
    Self as gold_marketplace_adapter,
    GoldFixedPriceListing,
};
use tobmate_asset::gold_nft::{Self as gold_nft};
use tobmate_asset::gold_reserve::{Self as gold_reserve};
use tobmate_asset::marketplace::{Self as marketplace};
use tobmate_integration_tests::test_support;
...
fun destroy_non_nft_fixture(
    access: tobmate_foundation::access_control::AccessControl,
    marketplace_object: tobmate_asset::marketplace::Marketplace,
    reserve: tobmate_asset::gold_reserve::GoldReserve,
    admin_cap: tobmate_asset::gold_nft::GoldNFTAdminCap,
    nft_registry: tobmate_asset::gold_nft::GoldNFTRegistry,
    mut dual_registry: tobmate_asset::dual_ownership::DualOwnershipRegistry,
    position: tobmate_asset::backing_position::GoldBackingPosition,
    record: tobmate_asset::dual_ownership::DualOwnershipRecord,
) {
...
fun destroy_complete_fixture(
    ...
    admin_cap: tobmate_asset::gold_nft::GoldNFTAdminCap,
    nft_registry: tobmate_asset::gold_nft::GoldNFTRegistry,
    dual_registry: tobmate_asset::dual_ownership::DualOwnershipRegistry,
    position: tobmate_asset::backing_position::GoldBackingPosition,
    nft: tobmate_asset::gold_nft::GoldNFT,
    record: tobmate_asset::dual_ownership::DualOwnershipRecord,
) {
...
#[expected_failure(
    ...
    location = tobmate_asset::gold_marketplace_adapter,
)]
...
fun gold_purchase_fee_vault_and_ownership_integration_succeeds() {
    ...
    use tobmate_asset::fee_vault::{Self as fee_vault};
    ...
    let receiving =
        test_scenario::receiving_ticket_by_id<
            tobmate_asset::gold_nft::GoldNFT,
        >(nft_id);
