#[test_only]
module tobmate_integration_tests::lp_reward_distributor_tests;
...
fun destroy_empty_fixture(
    ...
    distributor:
        tobmate_finance::lp_reward_distributor::LPRewardDistributor,
    admin_cap:
        tobmate_finance::lp_reward_distributor::LPRewardAdminCap,
) {
