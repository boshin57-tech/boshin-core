#[test_only]
module tobmate_integration_tests::dex_fee_settlement_tests;
...
use tobmate_finance::dex_fee_settlement;
use tobmate_asset::fee_vault;
use tobmate_finance::insurance_fund;
use tobmate_finance::liquidity_pool;
use tobmate_finance::lp_reward_distributor;
use tobmate_finance::revenue_router;
...
#[expected_failure(
    abort_code = 1,
    location = tobmate_finance::dex_fee_settlement,
)]
