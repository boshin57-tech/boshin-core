module tobmate_finance::oracle_feed;
...
public fun create_feed_store(
    ...
    let store = OracleFeedStore {
        id: object::new(ctx),
        registry_id: tobmate_finance::oracle::registry_id(registry),
        next_feed_id: 1,
        feed_count: 0,
        observation_count: 0,
        feeds: vector[],
...
public fun register_feed(
    ...
    assert!(!tobmate_finance::oracle::is_paused(registry), E_PROTOCOL_PAUSED);
...
public fun submit_observation(
    ...
    tobmate_finance::oracle::assert_valid_publisher(
        registry,
        publisher_cap,
        sender,
    );
...
fun oracle_admin_registry_id(
    ...
    tobmate_finance::oracle::admin_registry_id(admin_cap)
}

fun publisher_cap_id(
    publisher_cap: &OraclePublisherCap,
): u64 {
    tobmate_finance::oracle::publisher_cap_id(publisher_cap)
}
