module tobmate_finance::bad_debt_settlement;
...
use tobmate_finance::lending_pool::{Self as lending_pool, LendingPool};
use tobmate_finance::insurance_fund::{Self as insurance_fund, InsuranceFund};
