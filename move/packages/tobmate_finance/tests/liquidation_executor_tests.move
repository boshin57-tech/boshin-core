#[test_only]
module tobmate_finance::liquidation_executor_tests;

use sui::test_scenario;

use tobmate_finance::liquidation_executor;
...
use tobmate_finance::liquidation_engine::{
...
#[expected_failure(
    abort_code = 8,
    location = tobmate_finance::liquidation_executor,
)]
