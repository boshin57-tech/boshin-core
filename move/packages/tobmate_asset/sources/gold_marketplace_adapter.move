module tobmate_asset::gold_marketplace_adapter;
...
use tobmate_asset::backing_position::{
    Self,
    GoldBackingPosition,
};
use tobmate_asset::dual_ownership::{
    Self,
    DualOwnershipRecord,
    DualOwnershipRegistry,
};
use tobmate_asset::gold_nft::{Self, GoldNFT};
use tobmate_asset::gold_reserve::{Self, GoldReserve};
use tobmate_asset::marketplace::{Self, Marketplace};
...
public fun buy_gold_fixed_price_with_fee_vault(
    ...
    marketplace: &mut Marketplace,
    fee_vault_object:
        &mut tobmate_asset::fee_vault::FeeVault,
    mut listing: GoldFixedPriceListing,
    nft_receiving: Receiving<GoldNFT>,
    registry: &mut DualOwnershipRegistry,
    record: &mut DualOwnershipRecord,
