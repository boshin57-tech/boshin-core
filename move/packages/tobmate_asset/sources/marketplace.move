module tobmate_asset::marketplace;
...
public(package) fun settle_external_fixed_price_sale_to_fee_vault(
    access_control:
        &tobmate_foundation::access_control::AccessControl,
    marketplace: &mut Marketplace,
    fee_vault_object:
    ...
    if (marketplace_fee > 0) {
        ...
        tobmate_asset::fee_vault::collect_fee(
            access_control,
            fee_vault_object,
            tobmate_asset::fee_vault::fee_marketplace(),
            fee_coin,
            ctx,
        );
    };
